...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.Text &
      Attribute.Required &
      Attribute.DefaultTo<'Cloud bread VHS hell of banjo bicycle rights jianbing umami mumblecore etsy 8-bit pok pok +1 wolf. Vexillologist yr dreamcatcher waistcoat, authentic chillwave trust fund. Viral typewriter fingerstache pinterest pork belly narwhal. Schlitz venmo everyday carry kitsch pitchfork chillwave iPhone taiyaki trust fund hashtag kinfolk microdosing gochujang live-edge'>;
    featured: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    category: Attribute.Enumeration<
      ['Sofas', 'Chairs', 'Tables', 'Beds', 'kids']
    > &
      Attribute.Required;
